...
import com.vaccine.getavailibility.model.Response;
	...
	public class MailServiceImpl  {
		...
		public void sendmail(List<Response> responseList) throws AddressException, MessagingException, IOException {
			   ...
			   {
				   html=html+"<tr>"+"<td>"+response.getName()+"</td><td>"+"::Available capacity is ::"+"<b>"+response.getAvailable_capacity()+"</b></td><td>"+response.getDate()+"</td><td>"+"::Minimum age limit is ::"+response.getMin_age_limit()+"</td>" + "<td>"+"::Pincode is ::"+response.getPincode()+"</td></tr>";
			   }
